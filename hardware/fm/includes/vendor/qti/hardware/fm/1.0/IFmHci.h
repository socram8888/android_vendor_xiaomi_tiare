...
struct IFmHci : public ::android::hidl::base::V1_0::IBase {
    ...
    virtual ::android::hardware::Return<void> initialize(const ::android::sp<IFmHciCallbacks>& callbacks) = 0;
    ...
    static ::android::hardware::Return<::android::sp<IFmHci>> castFrom(const ::android::sp<IFmHci>& parent, bool emitError = false);
    static ::android::hardware::Return<::android::sp<IFmHci>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
std::string toString(const ::android::sp<IFmHci>&);
